...
void tokenizer_operator_tests() {
  ...
  ASSERT_EQ(list->tokens[0].source->length, 3, "of length 3");
  ASSERT_EQ(list->tokens[1].type, TOKEN_SYNTAX_OPERATOR, "followed by an operator token");
  ASSERT_EQ(list->tokens[1].source->length, 1, "of length 1");
  ...
  ASSERT_EQ(list->tokens[5].type, TOKEN_SYNTAX_OPERATOR, "followed by an operator token");
  ...
  ASSERT_EQ(list->tokens[7].type, TOKEN_SYNTAX_OPERATOR, "followed by an operator token");
  ...
  ASSERT_EQ(list->tokens[10].type, TOKEN_SYNTAX_OPERATOR, "followed by an operator token");
